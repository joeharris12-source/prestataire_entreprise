    ...
    <div class="container-principale">
        ...
        <div class="form-container">
            ...
            <div class="button-group">
                <a href="{{ route('login') }}" class="btn-particulier">Particulier</a>
                <a href="#" class="btn-entreprise">Entreprise</a>
            </div>
            <form action="{{ route('entrprestataires.register') }}" method="POST" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        @if ($errors->has('nom_responsable'))
                            <span class="error-message">{{ $errors->first('nom_responsable') }}</span>
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @if ($errors->has('nom_entreprise'))
                            <span class="error-message">{{ $errors->first('nom_entreprise') }}</span>
                        @endif
                    </div>
                    <div class="form-group">
                        <label for="date_creation_entreprise">Date de création :</label>
                        <input type="date" id="date_creation_entreprise" name="date_creation_entreprise" value="{{ old('date_creation_entreprise') }}" required>
                        @if ($errors->has('date_creation_entreprise'))
                            <span class="error-message">{{ $errors->first('date_creation_entreprise') }}</span>
                        @endif
                    </div>
